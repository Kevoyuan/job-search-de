...
- **4 Built-in Design Themes**: Instant switching between **Notion Craft**, **Linear Obsidian (Dark Mode)**, **Bauhaus Grid**, and **Bento Quartz** with zero token overhead and local persistence.
